...
{
    public function getPoolTiming(){
        return PoolTiming::all();
    }
    public function updatePoolTiming(Request $req, $email){
        $pm = PoolTiming::find($email);
        $pm -> starttime= $req->user2;
        $pm -> endtime = $req->user3;
        $pm ->update();
        return $pm;
    }
