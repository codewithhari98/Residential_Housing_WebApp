...
class PostServices extends Component {
    ...
    render() { 
        return (
          ...
          <h2 styles="font-size:2vw">Terrazas de Guacuco: more than just a roof, it's a lifestyle</h2><br />
            ...
            <div className = "postservicee-grid-container">
              <div>   
                <br/>
            <img className="service-imgs" src="images/pic1.jpg" alt="" />
              <p><span><a href="#" class="nulla">Fitness Centers, Swimming Pools, Community Spaces</a></span><br /></p>
                <br />
                <span>Fitness Centers: Our state-of-the-art fitness centers are equipped with the latest exercise equipment, including treadmills, ellipticals, free weights, and more. Whether you are a seasoned fitness enthusiast or just starting out, our fitness centers have everything you need to get in shape and stay healthy. And with flexible hours, you can exercise whenever it's convenient for you. </span><br />
                <br />
              ...
              <p><span><a href="#" class="nulla">On-Site Management</a></span><br /></p>
                <br />
