...
import { Link, useLocationm, useNavigate } from "react-router-dom";
...
class Sidebar extends Component {
  ...
  handleLogout = () => {
    ...
    axios.get(`http://127.0.0.1:8000/deleteLoginDetailsRoute/${this.state.email}`)
    .then(res => {
      console.log(res);
...
export default myParams(Sidebar);