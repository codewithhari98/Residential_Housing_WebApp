    ...
    constructor(props){
      ...
      verifyoutput = event => {
        ...
        if(this.state.startdate != '' && this.state.enddate!='') { 
            ...
            axios.get(`http://127.0.0.1:8000/getSecurityManagerReportRoute/${this.state.startdate}/${this.state.enddate}`, { user1:this.state.startdate , user2 : this.state.enddate})
            .then(res => {
              console.log(res);
