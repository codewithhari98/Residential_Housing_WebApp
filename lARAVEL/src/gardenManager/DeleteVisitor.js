...
class DeleteVisitor extends Component {
    ...
    state = {
      ...
      handleSubmit = event => {
        ...
        axios.get(`http://127.0.0.1:8000/deletevisitorroute/${this.state.email}`, { user1:this.state.email})
          .then(res => {
            console.log(res);
        ...
        return (
            <div>
                ...
                <div className="grid-container">
                    ...
                    <input  type="email"  value = {this.state.email}onChange={this.handleChange} placeholder="Visitor-Email" name="email" id="email"   required/><br/>
