...
class UpdateRegisterVehicle extends Component {
      ...
      handleSubmit = event => {
        ...
        axios.put(`http://127.0.0.1:8000/updateResidentRegistervehicle/${this.state.dlplatenumber}`, { user1:this.state.email,user2:this.state.vehiclemodel,user3:this.state.vehicleyear,
        user4:this.state.vehiclecolor
        ...
        return (
            ...
            <form onSubmit={this.handleSubmit}>
                <div className="grid-container">
                    ...
                    <div className= "form-control">
                    <input type="text" value = {this.state.dlplatenumber} onChange={this.handleChange} placeholder=" dlplatenumber" name="dlplatenumber" id="dlplatenumber" required/>
                    </div>
                    <div className ="form-control">
...
export default UpdateRegisterVehicle;