...
class CreateResident extends Component { 
      ...
      handleSubmit = event => {
        ...
        axios.post("http://localhost/wdm/create_resident.php", { user1:this.state.name,user2:this.state.email,user3:this.state.contact,user4:this.state.ssn,
        user5:this.state.password,user6:this.state.dob,user7:this.state.movein,user8:this.state.moveout,user9:this.state.type
        ...
        return (
            ...
            <form onSubmit={this.handleSubmit}>
                <div className="grid-container-resident">
                    ...
                    <div className ="form-control">
                    <input type="text" value = {this.state.type} onChange={this.handleChange}  placeholder="Enter Resident Type (owner, stl, ltl)" name="type" id="type"   required/>
                    </div>
                    <div className = "form-control">
