    ...
    return (
        <Fragment>
            ...
            <div className="grid-container-resident">
                ...
                <div>
                        <p><b>Registered Vehicles</b></p>
                        <img border="0" alt="Sorry ! unavailable" src="images/vehicle.svg" style={{width: '60%'}}/>
                        <Link to="/RegisteredVehicles"><button href="about">Registered vehicles</button> </Link>
