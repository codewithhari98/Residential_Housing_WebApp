...
class Resident_tennissubscription extends Component {
      ...
      handleSubmit = event => {
        ...
        alert('Tennis subscription submitted successfully');

    
        axios.post("http://localhost/wdm/payment.php", { user1:this.state.amount,user2:this.state.name,user7: this.state.email, user3:this.state.card,user4:this.state.expiry,
        ...
        return (
            ...
            <form onSubmit={this.handleSubmit}>
                <div className="grid-container">
                    <div className='frm'>
                        <h1>Make payment for subscription of Tennis</h1>
...
export default Resident_tennissubscription;