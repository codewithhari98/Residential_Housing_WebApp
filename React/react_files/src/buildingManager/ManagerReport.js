...
class ManagerReportGeneration extends Component {
    state = {  } 
    render() { 
        return (
            <div>
    ...
    <form>
      ...
      <div className = "grid-containers">
        <div>
          ...
          <a>
          <img border="0" alt="Sorry ! unavailable" src="images/bargraph.jpg" width="100" height="160"/>
          </a>
        </div>
        <div>
            <p> Count</p>
            <a>
            <img border="0" alt="Sorry ! unavailable" src="images/piechart.jpg"  width="100" height="160"/>
            </a>
        </div>
        <div>
        <p> Salary</p>
        <a>
            <img border="0" alt="Sorry ! unavailable" src="images/enroll.jpg" width="100" height="160"/>
            </a>
        </div>
        </div>
    </div>
